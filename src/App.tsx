    ...
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 transition-colors duration-500">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-stone-900/40 to-stone-50 dark:to-stone-950 transition-colors duration-500"></div>
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-stone-900 dark:text-stone-100 mb-6 leading-tight">
      ...
      <section className="py-24 px-4 bg-white dark:bg-stone-900 transition-colors">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-stone-900 dark:text-stone-100 mt-3 mb-6">A Dining Experience Like No Other</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-8 bg-stone-50 dark:bg-stone-800 rounded-3xl border border-stone-100 dark:border-stone-700 hover:border-amber-500 transition-all group">
                <span className="text-5xl mb-6 block group-hover:scale-110 transition-transform">{feat.icon}</span>
                <h3 className="text-xl font-bold text-stone-900 dark:text-stone-100 mb-3">{feat.title}</h3>
                <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{feat.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-stone-900 dark:text-stone-100 mt-3 mb-6">Featured Dishes</h2>
            <div className="w-24 h-1 bg-amber-600 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={dish.id} className="bg-white dark:bg-stone-900 rounded-3xl overflow-hidden shadow-xl shadow-stone-200 dark:shadow-none border border-stone-100 dark:border-stone-800 group hover:-translate-y-2 transition-all">
                <div className="h-64 overflow-hidden relative">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 dark:bg-stone-900/90 backdrop-blur px-4 py-1 rounded-full font-bold text-amber-600">
                    {dish.price}
                  </div>
                </div>
                <div className="p-8">
                  <h3 className="text-2xl font-serif font-bold text-stone-900 dark:text-stone-100 mb-3">{dish.name}</h3>
                  <p className="text-stone-600 dark:text-stone-400 mb-6">{dish.desc}</p>
                  <Link to="/menu" className="text-amber-600 dark:text-amber-500 font-bold flex items-center gap-2 group-hover:gap-3 transition-all">
                    View Menu <span>→</span>
                  </Link>
                </div>
              </div>
      ...
      {/* About Section */}
      <section className="py-24 px-4 bg-amber-50 dark:bg-stone-800/20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            <span className="text-amber-600 font-semibold tracking-widest uppercase text-sm">Our Story</span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-stone-900 dark:text-stone-100 mt-3 mb-8 leading-tight">
            ...
            <Link
              to="/booking"
              className="inline-block px-10 py-4 bg-stone-900 dark:bg-amber-600 text-white rounded-full font-bold transition-all hover:bg-stone-800 dark:hover:bg-amber-700 shadow-lg"
            >
              Reserve Your Table
            </Link>
          </div>
