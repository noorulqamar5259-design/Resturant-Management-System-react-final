...
function Home() {
  return (
    <div className="min-h-screen bg-background transition-colors duration-500">
      ...
      {/* Features Section */}
      <section className="py-24 px-4 bg-background transition-colors">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-amber-600 font-semibold tracking-widest uppercase text-sm">Why Choose Us</span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-primary mt-3 mb-6">A Dining Experience Like No Other</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-8 bg-surface rounded-3xl border border-border-dim hover:border-accent transition-all group">
      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-primary mt-3 mb-6">Featured Dishes</h2>
            <div className="w-24 h-1 bg-amber-600 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={dish.id} className="bg-background rounded-3xl overflow-hidden shadow-xl shadow-stone-200 dark:shadow-none border border-border-dim group hover:-translate-y-2 transition-all">
                <div className="h-64 overflow-hidden relative">
                  ...
                  <div className="absolute top-4 right-4 bg-surface/90 backdrop-blur px-4 py-1 rounded-full font-bold text-accent">
                    {dish.price}
                  </div>
                </div>
                <div className="p-8">
                  <h3 className="text-2xl font-serif font-bold text-primary mb-3">{dish.name}</h3>
                  <p className="text-secondary mb-6">{dish.desc}</p>
                  <Link to="/menu" className="text-accent font-bold flex items-center gap-2 group-hover:gap-3 transition-all">
                    View Menu <span>→</span>
                  </Link>
                </div>
              </div>
      ...
      <section className="py-24 px-4 bg-surface">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-primary mt-3 mb-8 leading-tight">
