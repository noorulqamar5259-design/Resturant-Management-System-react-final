    ...
    <div className="min-h-screen bg-background transition-colors duration-500">
      ...
      <header className="py-24 px-4 bg-background border-b border-border-dim text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-bold text-primary mt-4 mb-6">About La Bella Cucina</h1>
      ...
      <main className="max-w-7xl mx-auto py-20 px-4 space-y-32">
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-serif font-bold text-primary mt-3 mb-6">Meet Our Team</h2>
            <div className="w-16 h-1 bg-amber-600 mx-auto rounded-full"></div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, i) => (
              <div key={i} className="bg-background rounded-[2.5rem] overflow-hidden border border-border-dim shadow-xl group hover:-translate-y-2 transition-all duration-500">
