      ...
      <main className="flex-1 flex items-center justify-center p-4 py-20">
        <div className="max-w-md w-full bg-background rounded-[3rem] shadow-2xl border border-border-dim p-10 md:p-12 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl font-serif font-bold text-primary mt-2">Login</h1>
          ...
          <div className="mt-10 text-center space-y-4">
            ...
            <div className="flex items-center gap-4 py-2">
              ...
              <span className="text-xs text-secondary uppercase font-bold">Or continue with</span>
              <div className="flex-1 h-px bg-border-dim"></div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 py-3 rounded-xl border border-border-dim hover:bg-surface transition-all text-primary">
