    ...
    <div className="min-h-screen bg-background transition-colors duration-500">
      ...
      <header className="py-24 px-4 bg-background border-b border-border-dim text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-bold text-primary mt-4 mb-6">Guest Reviews</h1>
      ...
      <main className="max-w-7xl mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          {stats.map((s, i) => (
            <div key={i} className="bg-background p-8 rounded-3xl border border-border-dim text-center shadow-lg shadow-black/5">
              <span className="text-4xl mb-4 block">{s.icon}</span>
              <h3 className="text-3xl font-serif font-bold text-accent">{s.value}</h3>
              <p className="text-secondary font-medium">{s.label}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-serif font-bold text-primary mt-3 mb-6">Recent Experiences</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {featuredReviews.map((r, i) => (
            <div key={i} className="bg-background p-8 rounded-3xl border border-border-dim shadow-xl dark:shadow-none hover:-translate-y-2 transition-all duration-300 relative group">
              ...
              <p className="text-secondary italic text-lg leading-relaxed mb-8">
                {r.text}
              </p>
              <div className="flex items-center gap-4 border-t border-border-dim pt-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-secondary">{r.context}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        {/* Review Form */}
        <div className="max-w-3xl mx-auto bg-background p-10 md:p-16 rounded-[3rem] shadow-2xl border border-border-dim relative overflow-hidden">
          ...
          <div className="relative z-10 text-center mb-12">
            ...
            <h2 className="text-3xl font-serif font-bold text-primary mt-2">Leave a Review</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full px-6 py-4 rounded-2xl bg-surface text-primary border-none focus:ring-2 focus:ring-accent transition-all appearance-none cursor-pointer"
              >
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full px-6 py-4 rounded-2xl bg-surface text-primary border-none focus:ring-2 focus:ring-accent transition-all h-40 resize-none"
      ...
      {toast && (
        <div className="fixed bottom-10 right-10 z-[100] animate-bounce-in">
          <div className="bg-primary text-background px-8 py-4 rounded-2xl shadow-2xl flex items-center gap-3 border border-border-dim">
